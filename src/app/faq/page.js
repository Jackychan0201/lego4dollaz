  ...
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-br from-gray-100 via-blue-50 to-yellow-50">
      ...
      <main className="flex-grow flex flex-col items-center justify-top">
        <h1 className="mt-10 text-2xl xl:text-4xl 2xl:tetx-5xl font-extrabold text-center text-gray-800 drop-shadow-sm tracking-wide">Frequently Asked Questions</h1>
        <div className="w-full flex justify-center">
          ...
          >
            <AccordionItem value="item-1">
              <AccordionTrigger className="font-semibold text-lg xl:text-2xl 2xl:text-3xl">Why LEGO bricks?</AccordionTrigger>
              <AccordionContent className="flex flex-col gap-4 text-balance text-base xl:text-xl 2xl:text-2xl text-gray-700">
            ...
            <AccordionItem value="item-2">
              <AccordionTrigger className="font-semibold text-lg xl:text-2xl 2xl:text-3xl">Why so expensive?</AccordionTrigger>
              <AccordionContent className="flex flex-col gap-4 text-balance text-base xl:text-xl 2xl:text-2xl text-gray-700">
            ...
            <AccordionItem value="item-3">
              <AccordionTrigger className="font-semibold text-lg xl:text-2xl 2xl:text-3xl">Return Policy</AccordionTrigger>
              <AccordionContent className="flex flex-col gap-4 text-balance text-base xl:text-xl 2xl:text-2xl text-gray-700">
            ...
            <AccordionItem value="item-4">
              <AccordionTrigger className="font-semibold text-lg xl:text-2xl 2xl:text-3xl">How to thank me</AccordionTrigger>
              <AccordionContent className="flex flex-col gap-4 text-balance text-base xl:text-xl 2xl:text-2xl text-gray-700">
