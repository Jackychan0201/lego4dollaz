...
export default function FAQ() {
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-br from-gray-100 via-blue-50 to-yellow-50">
      <Header />
      <main className="flex-grow flex flex-col items-center justify-center mb-10">
        <div className="w-full max-w-2xl bg-white/80 rounded-xl shadow-lg p-8 mt-10 border border-gray-200">
          <h1 className="text-2xl xl:text-4xl 2xl:text-5xl font-extrabold text-center text-gray-800 drop-shadow-sm tracking-wide mb-6">About</h1>
          <p className="mb-4 text-gray-700 text-base xl:text-xl">
          ...
          <p className="mb-4 italic text-gray-600 text-base xl:text-xl 2xl:text-2xl">Okay just kidding. My name is Yauheni Budzko, and I am a fullstack developer,
          ...
          <p className="text-gray-700 text-base xl:text-lg 2xl:text-2xl">
